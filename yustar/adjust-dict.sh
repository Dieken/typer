...
export R=$HOME/tmp/input-method-analysis/yustar/宇浩星陳_v3.8.0-beta.20250210/schema
...
perl -CSDA -lanE '$ok = 1 if /^\.\.\./; next unless $ok && $F[1]; print "$F[1]\t$F[0]"' yustar_sc.all.dict.yaml > q.txt
